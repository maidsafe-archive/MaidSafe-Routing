...
struct CompileTimeMapper {
 private:
  ...
  using RootNode = CompileTimeMap<
      ...
      Pair<MessageTypeTag::GetDataResponse, GetDataResponse>, Pair<MessageTypeTag::GetKey, GetKey>,
      Pair<MessageTypeTag::GetKeyResponse, GetKeyResponse>, Pair<MessageTypeTag::PutData, PutData>,
